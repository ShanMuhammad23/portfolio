  ...
  return (
   <section id="mySkills" className="mt-12 sm:w-[95%] m-auto rounded-2xl p-4 flex flex-col items-center bg-gray-500 bg-opacity-10">
    ...
    <div className="flex flex-col gap-3 p-4 ">
        ...
        <div className="h-[50px] sm:w-2/3 border-2 border-violet-800 rounded-full">
            <motion.div
            initial={{ width:40 }}
            whileInView={{ width:"95%"}}
            transition={{duration:0.5,delay:0}}
            className="bg-gray-500 bg-opacity-30 h-full rounded-full w-[95%] flex items-center justify-center">
    ...
    <div className="flex flex-col gap-3 p-4">
        ...
        <div className="h-[50px] sm:w-2/3 border-2 border-violet-800 rounded-full">
           ...
           transition={{duration:0.5,delay:0}}
            className="bg-gray-500 bg-opacity-30 h-full rounded-full w-[90%] flex items-center justify-center">
    ...
    <div className="flex flex-col gap-3 p-4">
        ...
        <div className="h-[50px] sm:w-2/3 border-2 border-violet-800 rounded-full">
          ...
          transition={{duration:0.5,delay:0}}
            className="bg-gray-500 bg-opacity-30 h-full rounded-full w-[75%] flex items-center justify-center">
    ...
    <div className="flex flex-col gap-3 p-4">
        ...
        <div className="h-[50px] sm:w-2/3 border-2 border-violet-800 rounded-full">
           ...
           transition={{duration:0.5,delay:0}}
            className="bg-gray-500 bg-opacity-30 h-full rounded-full w-[80%] flex items-center justify-center">
    ...
    <div className="flex flex-col gap-3 p-4">
        ...
        <div className="h-[50px] sm:w-2/3 border-2 border-violet-800 rounded-full">
           ...
           transition={{duration:0.5,delay:0}}
            className="bg-gray-500 bg-opacity-30 h-full rounded-full w-[60%] flex items-center justify-center">
