...
const Footer = () => {
  ...
  className="flex flex-col  gap-4 p-6 mt-12 bg-gray-300 bg-opacity-5">
    <div className="flex justify-between gap-2   flex-col sm:flex-row ">
        <div className="flex flex-col gap-4 justify-between border-b-2 sm:border-0 sm:w-2/6"> <h1 className="text-2xl text-violet-500 text-bold">Shan Muhammad</h1>
        ...
        <div className="flex gap-3 items-center text-white">
            <FaFacebook  className="bg-blue-700  h-[40px] w-[40px] rounded-xl cursor-pointer"/>
            <FaLinkedin  className="text-blue-600 bg-slate-50  h-[40px] w-[40px] rounded-xl cursor-pointer"/>
            <FaGithub  className="bg-black text-white  h-[40px] w-[40px] rounded-xl cursor-pointer"/>
            <a href="https://www.instagram.com/shani_developer/" target="_blank"><FaInstagram className="text-red-600 bg-slate-50  h-[40px] w-[40px] rounded-xl cursor-pointer" /></a>
        </div></div>
       <div className="flex flex-col gap-2 border-b-2 sm:border-0 ">
